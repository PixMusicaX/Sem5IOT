...
SELECT CONCAT(f_name, '’s monthly salary is Rs. ', FORMAT(salary, 0)) AS 'Monthly Salary Details' FROM employee;
...
-- [Refer to the table in Question. Hint: Its the depeartment table made in A2.]
